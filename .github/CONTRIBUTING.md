# 🤝 Contributing to Postgres Stack

Thank you for your interest in contributing to our PostgreSQL local development setup project! We welcome contributions that help improve our PostgreSQL configuration and expand our local development capabilities.
...
1. **Fork and Clone the Repository**
   ```bash
   git clone https://github.com/mtnvencenzo/postgres-stack.git
   cd postgres-stack
   ```
...
1. **Create a feature branch**
   ...
   # or
   git checkout -b fix/pgadmin-issue
   ```
...
3. **Test your changes**
   ...
   docker exec postgres psql -U admin -d postgres -c "CREATE TABLE test (id SERIAL PRIMARY KEY);"
   docker exec postgres psql -U admin -d postgres -c "DROP TABLE test;"
